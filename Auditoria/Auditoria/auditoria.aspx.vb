        ...
        For Each row As GridViewRow In GridViewData.Rows
            ...
            If formatStock((unStockTextBox)) <> Trim(unStockDataTable) Then
                ...
                If CInt(unaTablaNuevaDeAuditoria.getItem(0, 0)) = 0 Then
                    unaTablaNuevaDeAuditoria.execQuery("INSERT INTO AUD_RELEVAMIENTOS VALUES(" & Application("unNumeroDeCE") & "," & Application("unNumeroDeSucursal") & ",'" & unPeriodoActual & "'," & unaFechaDataTable & "," & CInt(unaTablaIdReferencia.getItem(0, 0)) & ",'" & formatStock(unStockTextBox) & "','" & radEstado.SelectedValue & "')")
                Else
